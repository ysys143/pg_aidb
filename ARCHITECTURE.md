...
└─────────────────────┼───────────────────────────────────┘
          ...
          ▼           ▼           ▼
  ┌───────────┐ ┌──────────┐ ┌──────────┐
  │ inference │ │  nl2sql  │ │ document │
  │  :8001    │ │  :8003   │ │  :8002   │
  │  Python   │ │  Python  │ │  Python  │
  │  FastAPI  │ │  FastAPI │ │  FastAPI │
  │  onnxrt   │ │  schema  │ │ chunking │
  └───────────┘ └──────────┘ └──────────┘
...
| nl2sql-service | Python (FastAPI) | sqlglot, LLM SDK 생태계 |
| document-service | Python (FastAPI) | unstructured, langchain 등 파서 |
